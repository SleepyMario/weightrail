...
class ChartData:
    ...
    weekly_trend: WeeklyTrendData | None
...
def prepare_chart_data(
    ...
    weekly_trend = calculate_weekly_trend(ordered_entries, current_date)
